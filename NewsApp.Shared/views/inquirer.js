NewsApp.inquirer = function (params) {
    ...
    var viewModel = {
        ...
        simpleList: {
            dataSource: new DevExpress.data.DataSource({ store: NewsApp.db.products }),
            rendered: ko.observable(false)
        },

        groupedList: {
            dataSource: new DevExpress.data.DataSource({ store: NewsApp.db.productsGrouped }),
            rendered: ko.observable(false)
        },

        customList: {
            dataSource: new DevExpress.data.DataSource({ store: NewsApp.db.productsCustom }),
            rendered: ko.observable(false),
